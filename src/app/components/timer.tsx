...
export function CountdownTimer({ targetDate }: CountdownTimerProps) {
  ...
  const [targetDatee] = useState(targetDate);
  //Boolean do sprawdzenia czy przeglądarka użytkownika załadowała kod do odliczania czasu.
  ...
  return (
    <div>
      ...
      <div>
        <p>Odliczanie do daty: { targetDatee.toString() }</p>
      </div>
    </div>
  );
}
